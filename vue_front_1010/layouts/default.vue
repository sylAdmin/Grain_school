<template>
  <div class="in-wrap">
    ...
    <!-- live2d看板娘 -->
    <script
      src="https://cdn.jsdelivr.net/gh/yubifeng/blog-resource/bloghosting/website/js/live2d/lib/L2Dwidget.min.js"></script>
    <!-- 公共头引入 -->
    <header id="header">
        ...
        <div class="h-r-nsl">
          ...
          <ul class="h-r-login">
            ...
            <el-upload
              ...
              :on-success="handleAvatarSuccess" title>
  ...
  export default {
    ...
    methods: {
      ...
      handleAvatarSuccess(res, file) {
        ...
        this.afterAvatarUpload()
      },

      afterAvatarUpload() {
        user.uploadUser(this.loginInfo)
          .then(response => {
            this.$message({
              type: "success",
              message: "更新头像成功",
